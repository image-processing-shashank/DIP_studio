...
export default function Page() {
  ...
  return (
    <div className={"shell" + (sidebarOpen ? "" : " rail") + (catalog ? "" : " no-nav")}>
      {/* Full-height flush-left sidebar */}
      {catalog && (
        <aside className="sidebar">
          <div className="sidebar-brand">
            ...
            <div className="sidebar-brand-text">
              <h1>DIP Studio</h1>
              <div className="sub">mPragati · IIT Delhi</div>
            </div>
          </div>
      ...
      {sidebarOpen && catalog && <div className="scrim" onClick={() => setSidebarOpen(false)} />}

      {/* Right column: flush topbar + continuous main */}
      <div className="maincol">
        <header className="topbar">
          ...
          <div className="topbar-title">Image Processing Pipeline</div>
